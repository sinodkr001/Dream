 ...
 if(isset($_POST['submit'])){
    ...
    if($payment_type=='cod'){
        $paymet_status='success';
    }
    $order_status='1';
    $added_on=date('y-m-d h:i:s');

    mysqli_query($con,"insert into `order`(user_id,address,city,pincode,payment_type,payment_status,order_status,added_on,total_price) values('$user_id','$address','$city','$pincode','$payment_type','$paymet_status','$order_status','$added_on','$total_price')");
                                                    ...
                                                    <div class="checkout-method__login">
                                                        <form id="login-form" method="post">
                                                            ...
                                                            <div class="single-input">
                                                             <input type="text" name="email" id="login_email" placeholder="Your Email*" style="width:100%">
